...
func _init(p_node_count: int = 8, p_res: Vector2 = Vector2(64, 64), p_erasure_start_phase: int = 0):
...
func duplicate_board() -> BoardDefinition:
	return BoardDefinition.new(node_count, resolution, erasure_start_phase)
